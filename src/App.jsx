...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-3 md:container  md:mx-auto my-5 rounded-xl p-5 bg-violet-300 min-h-[80vh] md:w-[50%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4 ">
          ...
          <div className="flex">
            ...
            <button
              ...
              onClick={handleAdd}
              className="bg-violet-800 disabled:bg-violet-700 hover:bg-violet-950 p-5 py-2 text-sm font-bold text-white rounded-full mx-2"
            >
              Save
            </button>
          </div>
                ...
                >
                  ...
                  <div className="buttons flex h-full">
                    <button
                      ...
                      className="bg-violet-800 hover:bg-violet-950 p-3 py-1 text-sm font-bold text-white rounded-lg mx-1"
                    >
                      <FaEdit />
                    </button>
                    <button
